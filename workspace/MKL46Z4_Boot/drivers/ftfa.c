...
void FTFA_ProgramWord(uint32_t address, uint32_t data){
	 ...
	 * AB->FCCOB4 (uint8_t)(data>>0)
	 * CD->FCCOB5 (uint8_t)(data>>8)
	 * EF->FCCOB6 (uint8_t)(data>>16)
	 * GH->FCCOB7 (uint8_t)(data>>24)
	 * */
    ...
    // Data parameter
    uint8_t FCCOB4 = (uint8_t)(data>>0); //MSB
    uint8_t FCCOB5 = (uint8_t)(data>>8);
    uint8_t FCCOB6 = (uint8_t)(data>>16);
